...
class _HomePageState extends State<HomePage> {
            ...
            child: Scaffold(
              ...
              body: ListView(
                ...
                children: [
                  ...
                  state is FindNearbyLoadingState ? Center(child: CircularProgressIndicator()) :
                  nearbyWidgets()
                ],
              ),
            ),
  ...
  Column nearbyWidgets() {
    List<Widget> lisst = [];
    for (int i = 0; i < BlocProvider.of<ApartmentController>(context).nearbyApartment.length; i++) {
        lisst.add(ApartHoriWidget(BlocProvider.of<ApartmentController>(context).nearbyApartment[i]));
    }
